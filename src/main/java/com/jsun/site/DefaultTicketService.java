...
import com.jsun.site.repositories.AttachmentRepository;
import com.jsun.site.repositories.TicketCommentRepository;
import com.jsun.site.repositories.TicketRepository;
import com.jsun.site.repositories.UserRepository;
...
public class DefaultTicketService implements TicketService {
	...
	public void save(Ticket ticket) {
		...
		entity.setUserId(this.userRepository.getByUsername(ticket.getCustomerName()).getId());
	...
	private TicketComment convert(TicketCommentEntity entity)
	{
		...
		comment.setCustomerName(this.userRepository.findOne(entity.getUserId()).getUsername());
		comment.setBody(entity.getBody());
		comment.setDateCreated(Instant.ofEpochMilli(entity.getDateCreated().getTime()));
	...
	public void save(TicketComment comment, long ticketId)
	{
		...
		entity.setUserId(this.userRepository.getByUsername(comment.getCustomerName()).getId());
